...
child_a_crf_2000 = FormsCollection(
    ...
    Crf(show_order=6, model='flourish_child.infantfeeding', required=False),
...
child_b_crf_2000 = FormsCollection(
    Crf(show_order=1, model='flourish_child.childhivrapidtestcounseling'),
    Crf(show_order=2, model='flourish_child.childmedicalhistory'),
    ...
    Crf(show_order=6, model='flourish_child.childtannerstaging',
        required=False),
    Crf(show_order=7, model='flourish_child.childfoodsecurityquestionnaire'),
...
child_c_crf_2000 = FormsCollection(
    ...
    Crf(show_order=4, model='flourish_child.childsociodemographic'),
    Crf(show_order=5, model='flourish_child.childphysicalactivity'),
    Crf(show_order=6, model='flourish_child.childphqdepressionscreening',
        required=False),
    Crf(show_order=7, model='flourish_child.childphqreferral',
        required=False),
    Crf(show_order=8, model='flourish_child.childgadanxietyscreening',
        required=False),
    Crf(show_order=9, model='flourish_child.childgadreferral',
        required=False),
    Crf(show_order=10, model='flourish_child.childtannerstaging',
        required=False),
    Crf(show_order=11, model='flourish_child.academicperformance',
        required=False),
    Crf(show_order=12, model='flourish_child.childfoodsecurityquestionnaire'),
    Crf(show_order=13, model='flourish_child.childpregtesting',
        required=False),
    Crf(show_order=14, model='flourish_child.childcliniciannotes'),
    Crf(show_order=15, model='flourish_child.childcovid19'),
...
child_b_crf_3000 = FormsCollection(
    Crf(show_order=1, model='flourish_child.childsociodemographic'),
    Crf(show_order=2, model='flourish_child.childclinicalmeasurements'),
    Crf(show_order=3, model='flourish_child.childmedicalhistory'),
    Crf(show_order=4, model='flourish_child.childphysicalactivity'),
...
child_c_crf_3000 = FormsCollection(
    ...
    Crf(show_order=3, model='flourish_child.childmedicalhistory'),
    Crf(show_order=4, model='flourish_child.childphysicalactivity'),
    Crf(show_order=5, model='flourish_child.academicperformance',
        required=False),
    Crf(show_order=6, model='flourish_child.childphqdepressionscreening',
        required=False),
    Crf(show_order=7, model='flourish_child.childphqreferral',
