...
a_crf_3000 = FormsCollection(
    ...
    Crf(show_order=7, model='flourish_caregiver.caregiverphqreferral',
        required=False),
    Crf(show_order=8, model='flourish_caregiver.caregiverphqreferralfu',
        required=False),
    Crf(show_order=9, model='flourish_caregiver.caregivergadreferral',
        required=False),
    Crf(show_order=10, model='flourish_caregiver.caregivergadreferralfu',
        required=False),
    Crf(show_order=11, model='flourish_caregiver.caregiveredinburghreferral',
        required=False),
    Crf(show_order=12, model='flourish_caregiver.caregiveredinburghreferralfu',
        required=False),
    Crf(show_order=13, model='flourish_caregiver.cliniciannotes'),
    Crf(show_order=14, model='flourish_caregiver.covid19'),
    Crf(show_order=15, model='flourish_caregiver.maternalinterimidcc',
        required=False),
    name='a_follow_up')
...
b_crf_3000 = FormsCollection(
    ...
    Crf(show_order=10, model='flourish_caregiver.caregivergadreferral',
        required=False),
    Crf(show_order=11, model='flourish_caregiver.caregivergadreferralfu',
        required=False),
    Crf(show_order=12, model='flourish_caregiver.caregiveredinburghreferral',
        required=False),
    Crf(show_order=13, model='flourish_caregiver.caregiveredinburghreferralfu',
        required=False),
    Crf(show_order=14, model='flourish_caregiver.caregivergadanxietyscreening'),
