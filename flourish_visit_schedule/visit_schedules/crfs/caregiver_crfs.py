...
a_crf_2000 = FormsCollection(
    ...
    Crf(show_order=7, model='flourish_caregiver.maternalinterimidccversion2',
        required=False),
    Crf(show_order=8, model='flourish_caregiver.hivviralloadandcd4',
        required=False),
    Crf(show_order=9, model='flourish_caregiver.arvsprepregnancy',
        required=False),
    Crf(show_order=10, model='flourish_caregiver.maternalarvduringpreg',
        required=False),
    Crf(show_order=11, model='flourish_caregiver.substanceusepriorpregnancy',
        required=False),
    Crf(show_order=12, model='flourish_caregiver.caregiverclinicalmeasurements',
        required=False),
    Crf(show_order=13, model='flourish_caregiver.caregiverphqdeprscreening'),
    Crf(show_order=14, model='flourish_caregiver.caregiverphqreferral',
        required=False),
    Crf(show_order=15, model='flourish_caregiver.caregiverphqreferralfu',
        required=False),
    Crf(show_order=16, model='flourish_caregiver.caregiveredinburghdeprscreening',
        required=False),
    Crf(show_order=17, model='flourish_caregiver.caregiveredinburghreferral', required=False),
    Crf(show_order=18, model='flourish_caregiver.caregiveredinburghreferralfu',
        required=False),
    Crf(show_order=19, model='flourish_caregiver.caregivergadanxietyscreening'),
    Crf(show_order=20, model='flourish_caregiver.caregivergadreferral',
        required=False),
    Crf(show_order=21, model='flourish_caregiver.caregivergadreferralfu',
        required=False),
    Crf(show_order=22, model='flourish_caregiver.tbhistorypreg',
        required=False),
    Crf(show_order=23, model='flourish_caregiver.tbroutinehealthscreen', required=False),
    Crf(show_order=24, model='flourish_caregiver.tbroutinehealthscreenv2'),
    Crf(show_order=25, model='flourish_caregiver.obstericalhistory',
        required=False),
    Crf(show_order=26, model='flourish_caregiver.cliniciannotes'),
    Crf(show_order=27, model='flourish_caregiver.covid19'),
    Crf(show_order=28, model='flourish_caregiver.relationshipfatherinvolvement'),
...
bc_crf_2000 = FormsCollection(
    ...
    Crf(show_order=19, model='flourish_caregiver.maternalarvadherence', required=False),
