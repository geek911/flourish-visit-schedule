...
from ..schedules import b_dyad1_schedule_1, b_dyad2_schedule_1, b_dyad3_schedule_1
from ..schedules import b_enrollment1_schedule_1, b_enrollment2_schedule_1
from ..schedules import b_enrollment3_schedule_1
from ..schedules import b_quarterly1_schedule_1, b_quarterly2_schedule_1
from ..schedules import b_quarterly3_schedule_1
...
cohort_b1_visit_schedule_v1.add_schedule(b_dyad1_schedule_1)
...
cohort_b2_visit_schedule_v1.add_schedule(b_dyad2_schedule_1)
...
cohort_b3_visit_schedule_v1.add_schedule(b_dyad3_schedule_1)
