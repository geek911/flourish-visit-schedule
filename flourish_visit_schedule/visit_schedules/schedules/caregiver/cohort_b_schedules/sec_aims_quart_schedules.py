...
b_sec_quart1_schedule_1 = Schedule(
    ...
    sequence='1',
    verbose_name='Cohort B(First Child(ren)) Sec Quarterly Aims Schedule',
...
b_sec_quart2_schedule_1 = Schedule(
    ...
    sequence='1',
    verbose_name='Cohort B(Second Child(ren)) Sec Quarterly Aims Schedule',
    onschedule_model='flourish_caregiver.onschedulecohortbsecquart',
    offschedule_model='flourish_caregiver.caregiveroffschedule',
    consent_model='flourish_caregiver.subjectconsent',
    appointment_model='edc_appointment.appointment'
...
b_sec_quart3_schedule_1 = Schedule(
    ...
    sequence='1',
    verbose_name='Cohort B(Third Child(ren)) Sec Quarterly Aims Schedule',
    onschedule_model='flourish_caregiver.onschedulecohortbsecquart',
    offschedule_model='flourish_caregiver.caregiveroffschedule',
    consent_model='flourish_caregiver.subjectconsent',
    appointment_model='edc_appointment.appointment'
