...
b_fu_quarterly1_schedule_1 = Schedule(
    ...
    sequence='4',
    verbose_name='Cohort B(First Child(ren)) FU Quarterly Schedule V1',
...
b_fu_quarterly2_schedule_1 = Schedule(
    ...
    sequence='4',
    verbose_name='Cohort B(Second Child(ren)) FU Quarterly Schedule V1',
    onschedule_model='flourish_caregiver.onschedulecohortbfu',
    offschedule_model='flourish_caregiver.caregiveroffschedule',
    consent_model='flourish_caregiver.subjectconsent',
    appointment_model='edc_appointment.appointment'
...
b_fu_quarterly3_schedule_1 = Schedule(
    ...
    sequence='4',
    verbose_name='Cohort B(Third Child(ren)) FU Quarterly Schedule V1',
    onschedule_model='flourish_caregiver.onschedulecohortbfu',
    offschedule_model='flourish_caregiver.caregiveroffschedule',
    consent_model='flourish_caregiver.subjectconsent',
    appointment_model='edc_appointment.appointment'
...
schedule_helper1 = ScheduleHelper(visit=visit3001, crfs=crf_2001,
                                  crfs_prn=caregiver_crfs_prn, schedule=b_fu_quarterly1_schedule_1)
