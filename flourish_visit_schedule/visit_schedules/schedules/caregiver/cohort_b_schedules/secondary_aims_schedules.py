...
b_sec1_schedule_1 = Schedule(
    ...
    sequence='1',
    verbose_name='Cohort B(First Child(ren)) Secondary Aims Schedule',
...
b_sec2_schedule_1 = Schedule(
    ...
    sequence='1',
    verbose_name='Cohort B(Second Child(ren)) Secondary Aims Schedule',
    onschedule_model='flourish_caregiver.onschedulecohortbsec',
    offschedule_model='flourish_caregiver.caregiveroffschedule',
    consent_model='flourish_caregiver.subjectconsent',
    appointment_model='edc_appointment.appointment'
...
b_sec3_schedule_1 = Schedule(
    ...
    sequence='1',
    verbose_name='Cohort B(Third Child(ren)) Secondary Aims Schedule',
    onschedule_model='flourish_caregiver.onschedulecohortbsec',
    offschedule_model='flourish_caregiver.caregiveroffschedule',
    consent_model='flourish_caregiver.subjectconsent',
    appointment_model='edc_appointment.appointment'
