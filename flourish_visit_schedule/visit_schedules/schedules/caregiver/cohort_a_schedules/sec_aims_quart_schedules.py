...
a_sec_quart1_schedule_1 = Schedule(
    ...
    sequence='1',
    verbose_name='Cohort A(First Child(ren)) Sec Quarterly Aims Schedule V1',
...
a_sec_quart2_schedule_1 = Schedule(
    ...
    sequence='1',
    verbose_name='Cohort A(Second Child(ren)) Sec Quarterly Aims Schedule V1',
    onschedule_model='flourish_caregiver.onschedulecohortasecquart',
    offschedule_model='flourish_caregiver.caregiveroffschedule',
    consent_model='flourish_caregiver.subjectconsent',
    appointment_model='edc_appointment.appointment'
...
a_sec_quart3_schedule_1 = Schedule(
    ...
    sequence='1',
    verbose_name='Cohort A(Third Child(ren)) Sec Quarterly Aims Schedule V1',
    onschedule_model='flourish_caregiver.onschedulecohortasecquart',
    offschedule_model='flourish_caregiver.caregiveroffschedule',
    consent_model='flourish_caregiver.subjectconsent',
    appointment_model='edc_appointment.appointment'
