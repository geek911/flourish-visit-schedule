...
a_antenatal1_schedule_1 = Schedule(
    ...
    sequence='1',
    verbose_name='Cohort A(First Child(ren)) Antenatal Schedule',
...
a_antenatal2_schedule_1 = Schedule(
    ...
    sequence='1',
    verbose_name='Cohort A(Second Child(ren)) Antenatal Schedule',
    onschedule_model='flourish_caregiver.onschedulecohortaantenatal',
    offschedule_model='flourish_caregiver.caregiveroffschedule',
    consent_model='flourish_caregiver.subjectconsent',
    appointment_model='edc_appointment.appointment'
...
a_antenatal3_schedule_1 = Schedule(
    ...
    sequence='1',
    verbose_name='Cohort A(Third Child(ren)) Antenatal Schedule',
    onschedule_model='flourish_caregiver.onschedulecohortaantenatal',
    offschedule_model='flourish_caregiver.caregiveroffschedule',
    consent_model='flourish_caregiver.subjectconsent',
    appointment_model='edc_appointment.appointment'
