...
a_sec1_schedule_1 = Schedule(
    ...
    onschedule_model='flourish_caregiver.onscheduleseca',
...
a_sec1_schedule_1.add_visit(visit=visit1000)
a_sec2_schedule_1.add_visit(visit=visit1000)
a_sec3_schedule_1.add_visit(visit=visit1000)
