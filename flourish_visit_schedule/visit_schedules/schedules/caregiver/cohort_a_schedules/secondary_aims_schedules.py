...
a_sec1_schedule_1 = Schedule(
    ...
    sequence='1',
    verbose_name='Cohort A(First Child(ren)) Secondary Aims Schedule',
...
a_sec2_schedule_1 = Schedule(
    ...
    sequence='1',
    verbose_name='Cohort A(Second Child(ren))  Secondary Aims Schedule',
    onschedule_model='flourish_caregiver.onschedulecohortasec',
    offschedule_model='flourish_caregiver.caregiveroffschedule',
    consent_model='flourish_caregiver.subjectconsent',
    appointment_model='edc_appointment.appointment'
...
a_sec3_schedule_1 = Schedule(
    ...
    sequence='1',
    verbose_name='Cohort A(Third Child(ren)) Secondary Aims Schedule',
    onschedule_model='flourish_caregiver.onschedulecohortasec',
    offschedule_model='flourish_caregiver.caregiveroffschedule',
    consent_model='flourish_caregiver.subjectconsent',
    appointment_model='edc_appointment.appointment'
