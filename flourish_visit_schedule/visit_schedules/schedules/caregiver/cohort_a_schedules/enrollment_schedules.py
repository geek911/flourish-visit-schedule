...
a_enrollment1_schedule_1 = Schedule(
    ...
    verbose_name='Cohort A(First Child(ren)) Enrollment Schedule V1',
...
a_enrollment2_schedule_1 = Schedule(
    ...
    verbose_name='Cohort A(Second Child(ren)) Enrollment Schedule V1',
    onschedule_model='flourish_caregiver.onschedulecohortaenrollment',
    offschedule_model='flourish_caregiver.caregiveroffschedule',
    consent_model='flourish_caregiver.subjectconsent',
    appointment_model='edc_appointment.appointment'
...
a_enrollment3_schedule_1 = Schedule(
    ...
    verbose_name='Cohort A(Third Child(ren)) Enrollment Schedule V1',
    onschedule_model='flourish_caregiver.onschedulecohortaenrollment',
    offschedule_model='flourish_caregiver.caregiveroffschedule',
    consent_model='flourish_caregiver.subjectconsent',
    appointment_model='edc_appointment.appointment'
