...
c_sec1_schedule_1 = Schedule(
    ...
    sequence='1',
    verbose_name='Cohort C(First Child(ren)) Secondary Aims Schedule',
...
c_sec2_schedule_1 = Schedule(
    ...
    sequence='1',
    verbose_name='Cohort C(Second Child(ren)) Secondary Aims Schedule',
    onschedule_model='flourish_caregiver.onschedulecohortcsec',
    offschedule_model='flourish_caregiver.caregiveroffschedule',
    consent_model='flourish_caregiver.subjectconsent',
    appointment_model='edc_appointment.appointment'
...
c_sec3_schedule_1 = Schedule(
    ...
    sequence='1',
    verbose_name='Cohort C(Third Child(ren)) Secondary Aims Schedule',
    onschedule_model='flourish_caregiver.onschedulecohortcsec',
    offschedule_model='flourish_caregiver.caregiveroffschedule',
    consent_model='flourish_caregiver.subjectconsent',
    appointment_model='edc_appointment.appointment'
