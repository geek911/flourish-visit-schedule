...
caregiver_pool1_schedule_1 = Schedule(
    ...
    sequence='4',
    verbose_name='Caregiver Pool(First Child(ren)) Schedule',
...
caregiver_pool2_schedule_1 = Schedule(
    ...
    sequence='4',
    verbose_name='Caregiver Pool(Second Child(ren)) Schedule',
    onschedule_model='flourish_caregiver.onschedulecohortcpool',
    offschedule_model='flourish_caregiver.caregiveroffschedule',
    consent_model='flourish_caregiver.subjectconsent',
    appointment_model='edc_appointment.appointment'
...
caregiver_pool3_schedule_1 = Schedule(
    ...
    sequence='4',
    verbose_name='Caregiver Pool(Third Child(ren)) Schedule',
    onschedule_model='flourish_caregiver.onschedulecohortcpool',
    offschedule_model='flourish_caregiver.caregiveroffschedule',
    consent_model='flourish_caregiver.subjectconsent',
    appointment_model='edc_appointment.appointment'
