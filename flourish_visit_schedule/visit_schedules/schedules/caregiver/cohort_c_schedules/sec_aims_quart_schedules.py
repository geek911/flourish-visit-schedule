...
c_sec_quart1_schedule_1 = Schedule(
    ...
    sequence='1',
    verbose_name='Cohort C(First Child(ren)) Sec Quarterly Aims Schedule',
...
c_sec_quart2_schedule_1 = Schedule(
    ...
    sequence='1',
    verbose_name='Cohort C(Second Child(ren)) Sec Quarterly Aims Schedule',
    onschedule_model='flourish_caregiver.onschedulecohortcsecquart',
    offschedule_model='flourish_caregiver.caregiveroffschedule',
    consent_model='flourish_caregiver.subjectconsent',
    appointment_model='edc_appointment.appointment'
...
c_sec_quart3_schedule_1 = Schedule(
    ...
    sequence='1',
    verbose_name='Cohort C(Third Child(ren)) Sec Quarterly Aims Schedule',
    onschedule_model='flourish_caregiver.onschedulecohortcsecquart',
    offschedule_model='flourish_caregiver.caregiveroffschedule',
    consent_model='flourish_caregiver.subjectconsent',
    appointment_model='edc_appointment.appointment'
